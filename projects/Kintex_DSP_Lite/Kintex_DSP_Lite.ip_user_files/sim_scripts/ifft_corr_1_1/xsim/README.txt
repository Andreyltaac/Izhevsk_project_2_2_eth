...
#
# Generated by export_simulation on Tue Nov 11 15:23:26 +0700 2025
#
################################################################################
...
'-reset_run' switch to the './ifft_corr_1.sh' script.

./ifft_corr_1.sh -reset_run
...
./ifft_corr_1.sh -noclean_files

For more information on the script, please type './ifft_corr_1.sh -help'.
