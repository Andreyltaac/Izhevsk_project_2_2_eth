...
#
# Generated by export_simulation on Mon Nov 10 16:57:09 +0700 2025
#
################################################################################
...
'-reset_run' switch to the './fft_corr_1.sh' script.

./fft_corr_1.sh -reset_run
...
./fft_corr_1.sh -noclean_files

For more information on the script, please type './fft_corr_1.sh -help'.
