...
assign corr_sig_i = {{14{xcorr_peak_i[17]}},xcorr_peak_i};
assign corr_sig_q = {{14{xcorr_peak_q[17]}},xcorr_peak_q};
...
logic [9:0] thr_lvl;
assign thr_lvl = (t_sync_ctrl[10] == 1) ? thr_lvl_auto : t_sync_ctrl[9:0];
...
(
	...
	.index_bw	(bw_control_rx    ),
	.ival		(1'd1             ),
	.thr_lvl	({{14{0}},thr_lvl}),// 50
	.thr_mode   (t_sync_ctrl[11]  ),// 0 -- thr_manual, 1-- thr_mean
	.addr_shft	(addr_shft        ),// 3424
	.odata_i	(corr_subc_i      ),
	.odata_q	(corr_subc_q      ),
	.peak_i		(xcorr_peak_i     ),
	.peak_q		(xcorr_peak_q     ),
...
filter_sop_new #(
	.W_COUNT				(32),
	.SZ_FRAME				(((1024+32)*50)	),
	.PHASE_WINDOW_TICKS		(3),
	.N_SOP					(20),
	.SOP_COUNT_HALF_WINDOW	(2),
	.N_LOCK					(10),
	.N_UNLOCK				(5)
)
filter_sop_sub
...
(
	...
	.index_bw           (bw_control_rx),
	.fr_sync_isop		(filt_osop), //corr_sop && filt_wind_sop // filt_osop
	.idata_i			(corr_subc_i),
	.idata_q			(corr_subc_q),
